...
.team-members-list { border-bottom: 1px solid #e5e7eb; }
...
.member-av { width: 30px; height: 30px; font-size: 12px; position: relative; }
.chat-av-sm, .member-av-sm { width: 26px; height: 26px; font-size: 10px; }
...
.member-info { flex: 1; overflow: hidden; cursor: pointer; }
.member-name { font-size: 13px; font-weight: 700; color: #172b4d; }
